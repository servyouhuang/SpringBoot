...
public class ExcelUtil {
	 ...
	 * @return
	 */
	public static void writeExcelTitle(String filePath, String[] ss,HSSFWorkbook workbook,String sheetName)
			throws IOException {
	...
	/**
	 * @info 写出Excel标题和内容 并且把数据放到缓存区
	 * @param titles 标题行数据,excelList 实际数据, sheetName 表名
	 * @return buf
	 */
	public static byte[] writeExcel(String[] titles,List<Map<Integer,
			String>> excelList,HSSFWorkbook workbook,String sheetName) throws IOException {
		HSSFSheet sheet = workbook.createSheet(sheetName);
